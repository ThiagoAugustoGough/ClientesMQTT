...
client = mqtt.Client("Sensor_TAS_2") #Usando o método 'Client' para criar e atribuir um 'ID' ao nosso sensor
client.tls_set("C:\\Users\\ThiagoGought\\Desktop\\CERTIFCADOS_SSL\\ISRG Root X1.crt")
...
while message_counter <= 25:
    ...
    client.publish("UMIDADE", num_aleatorio) #enviar mensagem, especificando como o primeiro parametro o topico e o segundo o payload/msg
