...
client = mqtt.Client("Sensor_TAS_1", transport="websockets") #Usando o método 'Client' para criar e atribuir um 'ID' ao nosso sensor
client.ws_set_options(path = "/mqtt", headers = None)
client.connect(url_broker, port = 80) #Conectando ao broker público do Eclipse
message_counter = 0
